global function OnWeaponPrimaryAttack_ammo_swap2
global function MpTitanAbilityAmmoSwap2_Init
global function OnWeaponOwnerChanged_titanability_ammo_swap2

#if SERVER
//global function OnWeaponNpcPrimaryAttack_ammo_swap2
global function AddAmmoStatusEffect2
...
void function MpTitanAbilityAmmoSwap2_Init()
{
	#if CLIENT
...
void function OnWeaponOwnerChanged_titanability_ammo_swap2( entity weapon, WeaponOwnerChangedParams changeParams )
{
	#if SERVER
...
void function AddAmmoStatusEffect2( entity player )
{
...
var function OnWeaponPrimaryAttack_ammo_swap2( entity weapon, WeaponPrimaryAttackParams attackParams )
{
...
//#if SERVER
//var function OnWeaponNpcPrimaryAttack_ammo_swap2( entity weapon, WeaponPrimaryAttackParams attackParams )
//{
...
void function ToggleWeaponMods( entity weaponOwner, entity primaryWeapon, entity weapon )
{
	if ( IsValid( primaryWeapon ) )
	{
		...
		ToggleMod( primaryWeapon, "EmpAmmoMode" )
	}
