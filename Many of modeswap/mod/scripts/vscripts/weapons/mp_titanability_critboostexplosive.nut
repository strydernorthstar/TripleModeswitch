global function OnWeaponPrimaryAttack_ammo_swap3
global function MpTitanAbilityAmmoSwap3_Init

//global function OnWeaponOwnerChanged_titanability_ammo_swap3

#if SERVER
//global function OnWeaponNpcPrimaryAttack_ammo_swap3
global function AddAmmoStatusEffect3
//global int WhatSwap = 1
...
void function MpTitanAbilityAmmoSwap3_Init()
{
	#if CLIENT
		//PrecacheHUDMaterial( titanstencil )
		//PrecacheHUDMaterial( POWER_SHOT_ICON_FAR )
	#endif
}

//void function OnWeaponOwnerChanged_titanability_ammo_swap3( entity weapon, WeaponOwnerChangedParams changeParams )
//{
//	#if SERVER
//	if ( IsValid( changeParams.newOwner ) && changeParams.newOwner.IsPlayer() )
//	{
//		AddAmmoStatusEffect2( changeParams.newOwner )
//	}
...
void function AddAmmoStatusEffect3( entity player )
{
...
var function OnWeaponPrimaryAttack_ammo_swap3( entity weapon, WeaponPrimaryAttackParams attackParams )
{
	...
	//if ( primaryWeapon.HasMod( "LongRangeAmmo" ) || primaryWeapon.HasMod( "CloseRangePowerShot" ) )
	//return 0
...
//#if SERVER
//var function OnWeaponNpcPrimaryAttack_ammo_swap3( entity weapon, WeaponPrimaryAttackParams attackParams )
//{
...
void function ToggleWeaponMods( entity weaponOwner, entity primaryWeapon, entity weapon )
{
	if ( IsValid( primaryWeapon ) )
	{
		...
		//I DONT CARE ABOUT THE BUGFIXES, IM REVERTING THAT
		//if ( primaryWeapon.HasMod( "LongRangePowerShot" ) || primaryWeapon.HasMod( "CloseRangePowerShot" ) )
			//return

		ToggleMod( primaryWeapon, "ExplosiveAmmoMode" )
	}

	if ( IsValid( weapon ) )
	{
		ToggleMod( weapon, "ammo_swap_ranged_mode2" )
	}
	...
	if ( IsValid( weaponOwner ) )
	{
		...
		{
			//ToggleMod( powerShotWeapon, "filler" )
		}
	}

	if ( weaponOwner.IsPlayer() )
	{
		AddAmmoStatusEffect2( weaponOwner )
